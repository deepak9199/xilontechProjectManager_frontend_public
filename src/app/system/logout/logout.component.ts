...
export class LogoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    iframe.id = 'projectmanager-ifr';
    iframe.style.display = "none";
    (<HTMLIFrameElement>iframe).src = environment.xilontechPortal;
    document.body.appendChild(iframe);
    this.postAdminData(environment.xilontechPortal, 'projectmanager');
    this.authService.logout()
    window.location.href = environment.xilontechPortal+'#/logout'
    //this.logout()
